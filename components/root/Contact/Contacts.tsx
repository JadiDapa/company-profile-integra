...
export function Contacts() {
  return (
    ...
    >
      <FadeIn className="flex w-full max-w-2xl flex-col items-center text-center lg:items-center">
      ...
      <Stagger className="grid w-full grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        {contactItems.map((item, index) => (
          <StaggerItem key={index}>
            <Card className="relative h-full overflow-hidden text-center shadow-xl">
